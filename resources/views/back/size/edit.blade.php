                        ...
                        <div class="card-body">
                                <form action="{{ Route('size.update',$sub->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{ $sub->name }}" placeholder="Enter Size Title" class="form-control" required>
                                   </div>
                                   <div class="form-group">
                                       <label for="title"> Short Code <span style="color:red;">*</span></label>
                                       <input type="text" name="shortcode" value="{{ $sub->shortcode }}" placeholder="Enter Size Short Code" class="form-control" required>
                                  </div>
                                  ...
                                  <div class="form-group">
                                       ...
                                       <select name="color_id" class="form-control" required>
                                           ...
                                           @foreach(\App\color::all() as $color)
                                            <option value="{{ $color->id }}" {{ $color->id == $sub->color_id ? 'selected' : ''}}>{{$color->name}} ({{ $color->shortcode }})</option>
                                           @endforeach
                                       </select>
                                  </div>
                                    <hr>
